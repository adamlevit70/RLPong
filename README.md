...
The agent observes the game state (ball position, paddle position, and their velocity) and learns how to react by trial and error. Over time, it improves by maximizing rewards for hitting the ball and scoring points, while getting punished for missing.
...
Check the requirements file in the repository to view the necessary libraries.
